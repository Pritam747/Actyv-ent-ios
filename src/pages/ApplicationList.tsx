...
import { fetchApplication } from '../services/ApplicationList.Service';
import { CommonService } from '../services/Common.Service';
import { Constants } from '../utils/constants';
import { displayDate } from '../utils/DateTimeUtils';
import { IApplicationEntry } from '../utils/models/ApproverInbox.interface';
import './Page.css';
...
const ApplicationList: React.FC = () => {
	...
	const fetchData = async (isFirstLoading = true) => {
		...
		if (filterValue) {
			obj.filter = {
				'applicationStatuses': [filterValue],
			};
		}
		setDataList([]);
		let res = await fetchApplication(obj);
